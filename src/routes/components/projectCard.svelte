...
<div
     class="w-xs h-80 overflow-hidden transition-all duration-200 hover:translate-2 hover:shadow-[-10px_-10px_20px_rgba(0,0,0,0.15)] rounded-xl bg-portfolio-blue cursor-pointer"
